                        ...
                        case MK23_NUM:
                                {
                                        if(ent->client->ps.gunframe == 46)
											if (newsounds->value)
                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/mk23out.wav"), 1, ATTN_NORM, 0);
											else
                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("weapons/mk23out.wav"), 1, ATTN_NORM, 0);
                                        else if(ent->client->ps.gunframe == 53)
											if (newsounds->value)
                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/mk23in.wav"), 1, ATTN_NORM, 0);
											else
												gi.sound(ent, CHAN_WEAPON, gi.soundindex("weapons/mk23in.wav"), 1, ATTN_NORM, 0);
                                        else if(ent->client->ps.gunframe == 59) // 3
											if (newsounds->value)
                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/mk23slap.wav"), 1, ATTN_NORM, 0);
											else
...
//											else
											...
											if (newsounds->value)
                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/mp5slap.wav"), 1, ATTN_NORM, 0);                               
											else
                        ...
                        case M4_NUM:
                                {
                                        if(ent->client->ps.gunframe == 52)
											if (newsounds->value)
                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/m4a1out.wav"), 1, ATTN_NORM, 0);
											else
                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("weapons/m4a1out.wav"), 1, ATTN_NORM, 0);
                                        else if(ent->client->ps.gunframe == 58)
											if (newsounds->value)
                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/m4a1in.wav"), 1, ATTN_NORM, 0);                               
											else
                        ...
                        case M3_NUM:
                                {
                                                                        ...
                                                                        {
											if (newsounds->value)
                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/m3in.wav"), 1, ATTN_NORM, 0); 
											else
                        ...
                        case SNIPER_NUM:
                                {
                                        ...
                                        {
											if (newsounds->value)
                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/ssgbolt.wav"), 1, ATTN_NORM, 0);      
											else
        ...
        if( ent->client->weaponstate == WEAPON_END_MAG)
        {
                                ...
                                //FIREBLADE
                        {
                                ent->client->latched_buttons &= ~BUTTON_ATTACK;
                                {
                                        ...
                                        {
											if (newsounds->value)
                                                gi.sound(ent, CHAN_VOICE, gi.soundindex("ltkwep/noammo.wav"), 1, ATTN_NORM, 0);
											else
                ...
                case MK23_NUM:
                                        {
                                                ...
                                                if(ent->client->ps.gunframe == 3) // 3
                                                {
                                                        ...
                                                        {
															if (newsounds->value)
                                                                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/mk23slde.wav"), 1, ATTN_NORM, 0);
															else
                                                        ...
                                                        else
                                                        {
															if (newsounds->value)
																...
																gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/noammo.wav"), 1, ATTN_NORM, 0);
                                                                //mk23slap
                ...
                case M4_NUM:
                        {
                                if(ent->client->ps.gunframe == 3) // 3
									if (newsounds->value)
                                        gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/m4a1slde.wav"), 1, ATTN_NORM, 0);
									else
...
//      safe_cprintf(ent, PRINT_HIGH, "Spread is %d\n", spread);
        ...
        else
        {
				...
				tempi = rand()%3;
				if (tempi==0)
	                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/pist1.wav"), 1, ATTN_NORM, 0);
				else if (tempi==1)
	                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/pist2.wav"), 1, ATTN_NORM, 0);
				else if (tempi==2)
	                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/pist3.wav"), 1, ATTN_NORM, 0);
				}
				else
...
void MP5_Fire(edict_t *ent)
{
        ...
        {       
			if (newsounds->value)
                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/mp5fire1.wav"), 1, ATTN_NORM, 0);
			else
...
void Sniper_Fire(edict_t *ent)
{
        ...
        {
					if (newsounds->value)
                        gi.sound(ent, CHAN_AUTO, gi.soundindex("ltkwep/ssgbolt.wav"), 1, ATTN_NORM, 0);
					else
        ...
        {
			if (newsounds->value)
                gi.sound(ent, CHAN_WEAPON, gi.soundindex("ltkwep/ssgfire.wav"), 1, ATTN_NORM, 0);
			else
