...
{
  "Çüüüüüüüüüüüüüüüüé",            // double line
  "previous page",
  "next page",
  "Use [ and ] to move cursor",
  "ENTER to select, TAB to exit",
  "", // single line
  "Çüüüüüüüüüüüüüüüüüüüüüüüüüüüé"  // double line
};
...
{ 
  ...
  if (title)
    strncat(X_MENU->xmenuentries[0].name, title, XMENU_TITLE_MAX-1);
  else
    strncat(X_MENU->xmenuentries[0].name, "Menu", XMENU_TITLE_MAX-1);
  if (subtitle)
