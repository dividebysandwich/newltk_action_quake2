...
//FIREBLADE
        ...
        gi.soundindex("ltk/team1w.wav");
        gi.soundindex("ltk/team2w.wav");
        gi.soundindex("ltk/draw.wav");
        gi.soundindex("ltk/headshot.wav");
        gi.soundindex("ltk/stomach.wav");
        gi.soundindex("ltk/prof.wav");
        gi.soundindex("ltk/1min.wav");
        gi.soundindex("ltk/5min.wav");
        
		gi.soundindex("weapons/pist1.wav");
		gi.soundindex("weapons/pist2.wav");
		gi.soundindex("weapons/pist3.wav");
